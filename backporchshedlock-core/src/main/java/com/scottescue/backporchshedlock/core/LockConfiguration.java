...
public class LockConfiguration {
    ...
    public LockConfiguration(@NotNull String name, @NotNull Instant lockAtMostUntil, @NotNull Instant lockAtLeastUntil) {
        this.name = Jdk8Methods.requireNonNull(name);
        this.lockAtMostUntil = Jdk8Methods.requireNonNull(lockAtMostUntil);
        this.lockAtLeastUntil = Jdk8Methods.requireNonNull(lockAtLeastUntil);
